...
public class ForgotPassword extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label lblConnection = new Label("Mot de passe oubli\u00E9");
        ...
        this.codeField.setPromptText("code");
        this.codeField.setDisable(true);
        this.codeField.setStyle("-fx-pref-width: 350px; -fx-background-color: #f0f0f0; -fx-background-radius: 30px; -fx-padding: 10px; -fx-font-family: 'Arial'; -fx-border-color: #ddd; -fx-border-radius: 30px;");

        // Bouton de connexion
        this.btnLogin = new Button("Recevoir Code");
        ...
        // Hyperliens
        Label linkPasDeCompte = new Label("Vous connaissez votre mot de passe ?");
        this.linkForgotPassword = new Hyperlink("Connectez-Vous !");
        linkForgotPassword.setStyle("-fx-font-size: 16px; -fx-text-fill: #ffca10; -fx-font-family: 'Arial'; -fx-font-weight: bold;");

        // HBox pour linkPasDeCompte et linkSignUp
        HBox signUpBox = new HBox(5, linkPasDeCompte);
        ...
        VBox fieldBox = new VBox(15, lblConnection, emailField,codeField, errorMessageLabel, btnLogin);
        ...
        this.codeField.setOnAction(this.controller);
